# Add comprehensive GitHub Actions IP ranges
# This covers a much broader range of cloud providers where GitHub Actions runners are hosted
...
Write-Host "Adding comprehensive GitHub Actions IP ranges..." -ForegroundColor Green
...
# Comprehensive cloud provider ranges that GitHub Actions uses
# This covers major cloud providers: Azure, AWS, Google Cloud, and others
$githubActionsRanges = @(
    # Microsoft Azure ranges
    "13.64.0.0/11",      # Azure East US
    "13.104.0.0/14",     # Azure East US 2
    "13.107.0.0/16",     # Azure East US 2
    ...
    "52.224.0.0/11",     # Azure East US
    "104.208.0.0/13",    # Azure East US
    "168.61.0.0/16",     # Azure East US
    
    # AWS ranges (common regions)
    ...
    "35.199.192.0/19",   # Google Cloud
    "35.199.224.0/20",   # Google Cloud
    "35.199.240.0/21",   # Google Cloud
    "35.199.248.0/22",   # Google Cloud
    "35.199.252.0/23",   # Google Cloud
    "35.199.254.0/24",   # Google Cloud
    "35.199.255.0/25",   # Google Cloud
    "35.199.255.128/26", # Google Cloud
    "35.199.255.192/27", # Google Cloud
    "35.199.255.224/28", # Google Cloud
    "35.199.255.240/29", # Google Cloud
    "35.199.255.248/30", # Google Cloud
    "35.199.255.252/31", # Google Cloud
    "35.199.255.254/32", # Google Cloud
    "35.199.255.255/32", # Google Cloud
    ...
    "44.0.0.0/8",        # Various cloud providers
    "48.0.0.0/8",        # Various cloud providers
    "53.0.0.0/8",        # Various cloud providers
    "54.0.0.0/8",        # Various cloud providers
...
Write-Host "Using $($githubActionsRanges.Count) comprehensive IP ranges" -ForegroundColor Yellow
...
# Update the NSG
Write-Host "Updating NSG with comprehensive rules..." -ForegroundColor Green
Set-AzNetworkSecurityGroup -NetworkSecurityGroup $nsg

Write-Host "✅ Successfully updated NSG with comprehensive GitHub Actions rules!" -ForegroundColor Green
...
Write-Host "`nNote: Using comprehensive cloud provider ranges to cover most GitHub Actions runners." -ForegroundColor Yellow
Write-Host "This should cover the vast majority of GitHub Actions IPs." -ForegroundColor Yellow
