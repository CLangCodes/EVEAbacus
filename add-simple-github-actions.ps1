# Add simple but effective GitHub Actions IP ranges
# This uses valid IP ranges that cover most GitHub Actions runners
...
Write-Host "Adding simple GitHub Actions IP ranges..." -ForegroundColor Green
...
# Simple but effective IP ranges that cover most GitHub Actions runners
# These are valid ranges that should work with Azure NSG
$githubActionsRanges = @(
    # Microsoft Azure ranges (where most GitHub Actions runners are)
    ...
    # AWS ranges (common regions for GitHub Actions)
    ...
    # Additional major cloud provider ranges
...
Write-Host "Using $($githubActionsRanges.Count) simple IP ranges" -ForegroundColor Yellow
...
# Update the NSG
Write-Host "Updating NSG with simple rules..." -ForegroundColor Green
Set-AzNetworkSecurityGroup -NetworkSecurityGroup $nsg

Write-Host "✅ Successfully updated NSG with simple GitHub Actions rules!" -ForegroundColor Green
...
Write-Host "`nNote: Using simple but effective cloud provider ranges." -ForegroundColor Yellow
